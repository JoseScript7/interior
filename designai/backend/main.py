"""
DesignAI Backend — FastAPI + Mangum Lambda Adapter
...
logger = Logger(service="designai-api")
tracer = Tracer(service="designai-api")
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "designai-api"}
