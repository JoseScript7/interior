"""
End-to-end smoke test / regression harness for DesignAI.
...
# --- Main -------------------------------------------------------------------
def main():
    p = argparse.ArgumentParser(description="DesignAI end-to-end smoke test.")
    ...
    print(f"\nDesignAI smoke test  api={api}  ws={'set' if args.ws_url else 'none'}\n")
