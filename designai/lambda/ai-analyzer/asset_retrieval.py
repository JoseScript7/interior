...
logger = Logger(service="designai-pipeline-asset-retrieval")
bedrock_client = boto3.client("bedrock-runtime")
s3_client = boto3.client("s3")

ASSETS_BUCKET = os.environ.get("ASSETS_BUCKET", "designai-assets")
...
def _search_catalog(query: str, category: str, embedding: list) -> dict | None:
    ...
    sample_assets = {
        "sofa": {"name": "Modern Sofa", "category": "sofa", "glbUrl": f"https://cdn.designai.app/assets/sofa-01.glb", "isPlaceholder": False},
        "chair": {"name": "Accent Chair", "category": "chair", "glbUrl": f"https://cdn.designai.app/assets/chair-01.glb", "isPlaceholder": False},
        "table": {"name": "Coffee Table", "category": "table", "glbUrl": f"https://cdn.designai.app/assets/table-01.glb", "isPlaceholder": False},
        "lighting": {"name": "Pendant Light", "category": "lighting", "glbUrl": f"https://cdn.designai.app/assets/light-01.glb", "isPlaceholder": False},
        "rug": {"name": "Area Rug", "category": "rug", "glbUrl": f"https://cdn.designai.app/assets/rug-01.glb", "isPlaceholder": False},
        "storage": {"name": "Bookshelf", "category": "storage", "glbUrl": f"https://cdn.designai.app/assets/shelf-01.glb", "isPlaceholder": False},
    }
