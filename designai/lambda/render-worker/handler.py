...
logger = Logger(service="designai-render-worker")
...
RENDERS_BUCKET = os.environ.get("RENDERS_BUCKET", "designai-renders")
PROJECTS_TABLE = os.environ.get("PROJECTS_TABLE", "designai-projects")

CONTROLNET_ENDPOINT = os.environ.get("SAGEMAKER_CONTROLNET_ENDPOINT", "designai-controlnet-endpoint")
MIDAS_ENDPOINT = os.environ.get("SAGEMAKER_MIDAS_ENDPOINT", "designai-midas-endpoint")
