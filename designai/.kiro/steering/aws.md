...
## S3 Bucket Naming
- designai-uploads-{accountId}: raw room photos
- designai-renders-{accountId}: AI generated images
- designai-assets-{accountId}: 3D models, textures (public via CloudFront)
